...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , br_comp_o{vlSymsp->TOP.br_comp_o}
    , rst_ni{vlSymsp->TOP.rst_ni}
    , io_sw_i{vlSymsp->TOP.io_sw_i}
    , io_lcd_o{vlSymsp->TOP.io_lcd_o}
    , io_ledg_o{vlSymsp->TOP.io_ledg_o}
    , io_ledr_o{vlSymsp->TOP.io_ledr_o}
    , io_hex0_o{vlSymsp->TOP.io_hex0_o}
    , io_hex1_o{vlSymsp->TOP.io_hex1_o}
    , io_hex2_o{vlSymsp->TOP.io_hex2_o}
    , io_hex3_o{vlSymsp->TOP.io_hex3_o}
    , io_hex4_o{vlSymsp->TOP.io_hex4_o}
